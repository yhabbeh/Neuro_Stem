...
class LoginRepositoriesImpl extends LoginRepositories {
  ...
  @override
  Future<Either<Failure, LoginUserModel>> loginUser(LoginDataModel loginUserModel) async{
    try {
      final LoginUserModel result = await loginRemoteDataSource.loginUser(loginUserModel);
      return Right(result);
